...
const AddDashboardTeam = () => {
    ...
    const addTeamHandler = (e) => {
        ...
        axios.post("/dashboard/our-team/add-team", data)
        .then(res=>{
            showSnackBar({
                value: true,
    ...
    return(
       <React.Fragment>
           <div className="d-add-dashboard-team">
            ...
            <form onSubmit={addTeamHandler} className="d-d-a-o-s">
                <div>
                    <TextField
                ...
                <KarimFileInput allowedFileTypes={["image/jpeg", "image/jpg", "image/svg", "image/png"]} setThumb={setThumb}/>
                <div>
                    <TextField
...
export default AddDashboardTeam;